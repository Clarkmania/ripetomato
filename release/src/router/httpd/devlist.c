...
void asp_devlist(int argc, char **argv)
{
	...
	if ((nvram_match("lan_proto", "dhcp")) || (nvram_match("lan1_proto", "dhcp")) || (nvram_match("lan2_proto", "dhcp")) || (nvram_match("lan3_proto", "dhcp")) || (nvram_match("lan4_proto", "dhcp")) || (nvram_match("lan5_proto", "dhcp")) || (nvram_match("lan6_proto", "dhcp")) || (nvram_match("lan7_proto", "dhcp")) ) {
