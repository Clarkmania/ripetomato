...
// advanced-routing
	...
	{ "dr_lan4_tx",			V_LENGTH(0, 32)		},
	{ "dr_lan4_rx",			V_LENGTH(0, 32)		},
	{ "dr_lan5_tx",			V_LENGTH(0, 32)		},
	{ "dr_lan5_rx",			V_LENGTH(0, 32)		},
	{ "dr_lan6_tx",			V_LENGTH(0, 32)		},
	{ "dr_lan6_rx",			V_LENGTH(0, 32)		},
	{ "dr_lan7_tx",			V_LENGTH(0, 32)		},
	{ "dr_lan7_rx",			V_LENGTH(0, 32)		},
...
// new_qoslimit
	...
	{ "limit_br4_enable",            V_01                   },
	{ "limit_br4_ulr",               V_RANGE(0, 999999)     },
	{ "limit_br4_ulc",               V_RANGE(0, 999999)     },
	{ "limit_br4_dlr",               V_RANGE(0, 999999)     },
	{ "limit_br4_dlc",               V_RANGE(0, 999999)     },
	{ "limit_br4_prio",              V_RANGE(0, 5)          },
	{ "limit_br5_enable",            V_01                   },
	{ "limit_br5_ulr",               V_RANGE(0, 999999)     },
	{ "limit_br5_ulc",               V_RANGE(0, 999999)     },
	{ "limit_br5_dlr",               V_RANGE(0, 999999)     },
	{ "limit_br5_dlc",               V_RANGE(0, 999999)     },
	{ "limit_br5_prio",              V_RANGE(0, 5)          },
	{ "limit_br6_enable",            V_01                   },
	{ "limit_br6_ulr",               V_RANGE(0, 999999)     },
	{ "limit_br6_ulc",               V_RANGE(0, 999999)     },
	{ "limit_br6_dlr",               V_RANGE(0, 999999)     },
	{ "limit_br6_dlc",               V_RANGE(0, 999999)     },
	{ "limit_br6_prio",              V_RANGE(0, 5)          },
	{ "limit_br7_enable",            V_01                   },
	{ "limit_br7_ulr",               V_RANGE(0, 999999)     },
	{ "limit_br7_ulc",               V_RANGE(0, 999999)     },
	{ "limit_br7_dlr",               V_RANGE(0, 999999)     },
	{ "limit_br7_dlc",               V_RANGE(0, 999999)     },
	{ "limit_br7_prio",              V_RANGE(0, 5)          },
