			...
			if (wl_sunit(uidx)<0) {
				...
				htmlOut += createFormFields([
					...
					{ title: 'Beacon Interval', name: 'wl'+u+'_bcn', type: 'text', maxlen: 5, size: 7,
						help: 'range: 1 - 65535; default: 100', value: nvram['wl'+u+'_bcn'] },
					...
					{ title: 'Maximum Clients', name: 'wl'+u+'_maxassoc', type: 'text', maxlen: 3, size: 5,
						help: 'range: 1 - 255; default: 128', value: nvram['wl'+u+'_maxassoc'] },
					...
					{ title: 'RTS Threshold', name: 'wl'+u+'_rts', type: 'text', maxlen: 4, size: 6,
						help: 'range: 0 - 2347; default: 2347', value: nvram['wl'+u+'_rts'] },
					...
					{ title: 'Transmit Power', name: 'wl'+u+'_txpwr', type: 'text', maxlen: 3, size: 5,
						suffix: hp ? 'mW (before amplication)' : 'mW',
						help: hp ? 'range: 1 - 251; default: 10' :
							'range: 0 - 400', tip: 'actual max depends on Country selected; use 0 for hardware default',
