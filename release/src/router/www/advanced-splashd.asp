			...
			<form id="_fom" method="post" action="tomato.cgi">
				...
				<script type="text/javascript">
					...
					$('#cat-configure').forms([
						...
						{ title: 'Login Timeout', name: 'NC_LoginTimeout', type: 'text', maxlen: 8, size: 4, value: nvram.NC_LoginTimeout, suffix: ' seconds' },
						{ title: 'Idle Timeout', name: 'NC_IdleTimeout', type: 'text', maxlen: 8, size: 4, value: nvram.NC_IdleTimeout, suffix: ' seconds', help: '0 - unlimited' },
