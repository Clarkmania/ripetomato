	...
	<script type='text/javascript'>
		...
		lg.setup = function() {
			...
			for (var i = 0; i <= MAX_BRIDGE_ID; i++) {
				selopt.push.apply(selopt, [[i, i.toString()]]);
			}
			this.init('lan-grid', '', (MAX_BRIDGE_ID+1), [
				{ type: 'select', options: selopt, prefix: '<div class="centered">', suffix: '</div>' },
		...
		<div class="box" data-box="network-wan">
			...
			<script type="text/javascript">
				$('#wan-settings').forms([
					...
					{ title: 'PIN Code', name: 'modem_pin', type: 'text', maxlen: 6, size: 8, value: nvram.modem_pin, tip: 'Advised to turn off PIN Code' },
					...
					{ title: 'Max Idle Time', indent: 2, name: 'ppp_idletime', type: 'text', maxlen: 5, size: 7, suffix: ' minutes',
						value: nvram.ppp_idletime },
					{ title: 'Redial Interval', indent: 2, name: 'ppp_redialperiod', type: 'text', maxlen: 5, size: 7, suffix: ' seconds',
						value: nvram.ppp_redialperiod },
					{ title: 'LCP Echo Interval', indent: 2, name: 'pppoe_lei', type: 'text', maxlen: 5, size: 7, suffix: ' seconds', help: 'range: 1 - 60; default: 10',
						value: nvram.pppoe_lei },
					{ title: 'LCP Echo Link fail limit', indent: 2, name: 'pppoe_lef', type: 'text', maxlen: 5, size: 7, help: 'range: 1 - 10; default: 5',
					...
					{ title: 'Route Modem IP', name: 'modem_ipaddr', type: 'text', maxlen: 15, size: 17, tip: 'must be in different subnet to router', help: '0.0.0.0 to disable', value: nvram.modem_ipaddr },
		...
		<div class="box" data-box="network-lan">
			...
			<script type="text/javascript">
				...
				$('.content.lan-settings').forms([
					...
					{ title: 'Static DNS', help: 'IP:port', name: 'f_dns_1', type: 'text', maxlen: 21, size: 25, value: dns[0] || '0.0.0.0' },
					...
					/* DNSSEC-BEGIN */
					{ title: 'Enable DNSSEC', name: 'f_dnssec_enable', type: 'checkbox', tip: 'must be supported by the upstream nameservers', value: (nvram.dnssec_enable == 1) },
					/* DNSSEC-END */
					/* DNSCRYPT-BEGIN */
					...
					{ title: 'Resolver', indent: 2, name: 'dnscrypt_resolver', type: 'select', options: [/*dnscrypt_resolvers*/], value: nvram.dnscrypt_resolver, help: '<a href=\'https://github.com/jedisct1/dnscrypt-proxy/blob/master/dnscrypt-resolvers.csv\' target=\'_new\'>Resolver Details</a>' },
					{ title: 'Resolver Address', indent: 2, name: 'dnscrypt_resolver_address', type: 'text', maxlen: 50, size: 25, value: nvram.dnscrypt_resolver_address, help: '<a href=\'https://github.com/jedisct1/dnscrypt-proxy/blob/master/dnscrypt-resolvers.csv\' target=\'_new\'>Resolver Details</a>' },
			...
			for (var uidx = 0; uidx < wl_ifaces.length; ++uidx) {
				...
				if (wl_sunit(uidx)<0) {
					...
					f = [
						...
						{ title: 'Group Key Renewal', indent: 2, name: 'wl'+u+'_wpa_gtk_rekey', type: 'text', maxlen: 4, size: 6, suffix: ' seconds',
