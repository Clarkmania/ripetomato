		...
		<div class="box" data-box="firewal-set">
			...
			<script type="text/javascript">
				$('.section.firewall').forms([
					...
					{ title: 'ICMP', indent: 3, name: 'f_icmp_limit_icmp', type: 'text', maxlen: 3, size: 3, suffix: ' requests/second', value: fixInt(nvram.block_wan_limit_icmp || 1, 1, 300, 5) },
					{ title: 'Traceroute', indent: 3, name: 'f_icmp_limit_traceroute', type: 'text', maxlen: 3, size: 3, suffix: ' requests/second', value: fixInt(nvram.block_wan_limit_tr || 5, 1, 300, 5) },
					{ title: 'Enable SYN cookies', name: 'f_syncookies', type: 'checkbox', value: nvram.ne_syncookies != '0' },
					{ title: 'Enable DSCP Fix', name: 'f_DSCP_fix_enable', type: 'checkbox', value: nvram.DSCP_fix_enable != '0', tip: ' Fixes Comcast incorrect DSCP which affects WIFI download speeds' }
				]);
			</script>
		</div>
