...
<content>
    ...
    <form id="_fom" method="post" action="tomato.cgi">
        ...
        <div class="span8"> 
            ...
            The TomatoAnon script will send information to an online database about your router's model and installed version of Tomato.<br>
            The information submitted is 100% anonymous and will ONLY be used for statistical purposes.<br>
            <b>This script does NOT collect or transmit any private or personal information whatsoever (e.g MAC addresses, IP addresses, etc.)!</b><br>
            The TomatoAnon script is fully open, and written in bash. Everyone is free to look at the information collected and transmitted to the database..<br>
            <br>
            The collected data can be viewed on the <a href="http://tomato.groov.pl/tomatoanon.php" target="_blank"><b>TomatoAnon statistics</b></a> page.<br>
            This information can assist in helping you select the best and most popular router available in your country or region.<br>
            You can find the most commonly used version of Tomato and which version is the most stable on each router model.<br>
            <br>
            The TomatoAnon script can be disabled in cases where you prefer not to contribute data or are uncomfortable with the data being collected..<br>
            You can always re-enable it at any time.<br>
            <br>
            The following data is collected and transmitted by TomatoAnon:<br>
            - MD5SUM of WAN+LAN MAC addresses - this provides a unique identifier for each router, e.g: 1c1dbd4202d794251ec1acf1211bb2c8<br>
            - Model of router, e.g: Asus RT-N66U<br>
            - Installed version of Tomato, e.g: 102 K26 USB<br>
            - Build Type, e.g: Mega-VPN-64K<br>
            - Country, e.g: POLAND<br>
            - ISO Country Code, e.g: PL<br>
            - Router uptime, e.g: 3 days<br>
            That`s it!!<br>
            <br>
