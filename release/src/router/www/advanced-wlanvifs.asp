				...
				for (var i = 1; i < tabs.length; ++i) {
					...
					f.push (
						...
						{ title: 'Wireless Mode', name: 'f_wl'+u+'_mode', type: 'select',
							...
							help: ' <b id="wl'+u+'_mode_msg" style="visibility:hidden"><small>note: you might wish to cross-check settings later on <a href=basic-network.asp>Basic/Network</a></small></b>' }
					);
					...
					f.push (
						...
						{ title: 'Group Key Renewal', indent: 2, name: 'wl'+u+'_wpa_gtk_rekey', type: 'text', maxlen: 4, size: 6, help: ' seconds',
